...
class Sorting {
     ...
     * Выбирается опорный элемент (первый элемент списка).
     * Если массив состоит менее чем из двух элементов, то он уже отсортирован.
     * Иначе исходный массив разделяется на два - числа меньше опорного и больше него.
     * Возвращается рекурсия левой части + опора+ рекурсия правой части.
     *
     * @param list неотсортированный целочисленный список
     * @return отсортированный в порядке возрастания список
     */
